...
//        File pluginsHome = new File("C:\\Program Files\\GATE_Developer_8.0\\plugins");
    ...
    public static void main(String args[]) throws GateException, IOException {
        ...
        System.setProperty("gate.plugins.home", "C:\\Program Files\\GATE_Developer_8.0\\plugins");
        System.setProperty("gate.site.config", "C:\\Program Files\\GATE_Developer_8.0\\gate.xml");
        ...
        String inputFilePath = "C:\\Users\\lapps\\Skydrive\\concept mapping\\test.txt";
        args  = new String []{new File(inputFilePath).toURI().toURL().toExternalForm()};
        Out.prln("args.length = " + args.length);
